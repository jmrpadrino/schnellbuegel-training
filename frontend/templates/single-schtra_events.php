...
<style>
	...
	.buchung-tab-list li{
		flex: 1;
		border-bottom: 1px solid #CE171A;
		text-align: center;
	}
				...
				<div class="single-event-registerform-title">
					...
					<div>
						...
						<ul class="buchung-tab-list" role="tablist">
							<li role="presentation" class="active"><a href="#privat" aria-controls="privat" role="tab" data-toggle="tab" data-target="privat">Anmeldung Privat</a></li>
							<li role="presentation"><a href="#geschaftlich" aria-controls="geschaftlich" role="tab" data-toggle="tab" data-target="geschaftlich">Anmeldung Geschäftlich</a></li>
						</ul>
						<!-- Tab panes -->
...
<input type="radio" name="anmeldung_privat[anrede]" value="frau"> Präsenzmodul 1 - Einstieg und Ankommen in der Ausbildung 08.11.2018 - Fußenegger und Partner, 1090 Wien - Angelika Fußenegger
									...
									<div class="row">
										<div class="col-sm-12">
											...
											<select id="privat-room_needed" name="anmeldung_privat[hotel-registration-data][room_needed]">
							...
							<div role="tabpanel" class="tab-pane" id="geschaftlich">
								<form id="anmeldung-geschaftlich" role="form" method="post">
									...
									<div class="row">
										<div class="col-sm-6">
											<h4>Firma *</h4>
											<input type="text" name="anmeldung_geschaftlich[vorname]">
										</div>
										<div class="col-sm-6">
											<h4>UID Nummer</h4>
											<input type="text" name="anmeldung_geschaftlich[nachname]">
										</div>
									</div>
									<div class="row">
										<div class="col-sm-6">
										...
										<div class="col-sm-6">
											<h4>Titel</h4>
											<input type="text" name="anmeldung_geschaftlich[title]">
										</div>
									</div>
									<div class="row">
										<div class="col-sm-6">
									...
									<div class="row">
										<div class="col-sm-12">
											<h4>Straße/Hausnr. *</h4>
											<input type="text" name="anmeldung_geschaftlich[strabe]">
										</div>
									</div>
									<div class="row">
										<div class="col-sm-6">
											<h4>PLZ *</h4>
											<input type="text" name="anmeldung_geschaftlich[plz]">
										</div>
										<div class="col-sm-6">
											<h4>Ort *</h4>
											<input type="text" name="anmeldung_geschaftlich[ort]">
										</div>
									</div>
									<div class="row">
										<div class="col-sm-12">
											<h4>E-Mail *</h4>
											<input type="text" name="anmeldung_geschaftlich[email]">
										</div>
									</div>
									<div class="row">
										<div class="col-sm-12">
											<h4>Telefonnummer</h4>
											<input type="text" name="anmeldung_geschaftlich[phone]">
										</div>
									</div>
									<div class="row">
										<div class="col-sm-12">
											<h4>Geburtsdatum (Optional für das Abschluss-Zertifikat)</h4>
											<input type="text" name="anmeldung_geschaftlich[brith-date]">
										</div>
									</div>
									<div class="row">
										<div class="col-sm-12">
											...
											<div class="row">
												<div class="col-xs-12">
													<button id="add-person" type="button">Weiterer Teilnehmer <i class="fas fa-plus"></i></button>
												</div>
											</div>
										</div>
									</div>
									<div class="row">
										<div class="col-sm-12">
											...
											<div id="geschaftlich-dif-billing-address" class="row" style="display: none;">
												...
												<div class="col-xs-12">
													<h5>Andere</h5>
													<select name="anmeldung_geschaftlich[dif-billing-address][andere]">
														<option value="herr">Herr</option>
														<option value="frau">Frau</option>
													</select>
												</div>
												<div class="col-xs-12">
													<h5>Titel</h5>
													<input type="text" name="anmeldung_geschaftlich[dif-billing-address][title]">
												</div>
												<div class="col-xs-12">
													<h5>Vorname *</h5>
													<input type="text" name="anmeldung_geschaftlich[dif-billing-address][vorname]">
												</div>
												<div class="col-xs-12">
													<h5>Nachname *</h5>
													<input type="text" name="anmeldung_geschaftlich[dif-billing-address][nachname]">
												</div>
												<div class="col-xs-12">
													<h5>Straße/Hausnr. *</h5>
													<input type="text" name="anmeldung_geschaftlich[dif-billing-address][strabe]">
												</div>
												<div class="col-xs-12">
													<h5>PLZ *</h5>
													<input type="text" name="anmeldung_geschaftlich[dif-billing-address][plz]">
												</div>
												<div class="col-xs-12">
													<h5>Ort *</h5>
													<input type="text" name="anmeldung_geschaftlich[dif-billing-address][ort]">
												</div>
											</div>
										</div>
									</div>
									<div class="row">
										<div class="col-sm-12">
											...
											<h5>Gerne reservieren wir für Sie ein Zimmer:</h5>
											<select id="geschaftlich_room_needed" name="anmeldung_geschaftlich[hotel-registration-data][room_needed]">
												<option value="0">ab dem Vortag</option>
												<option value="1">ab dem ersten Seminartag</option>
												<option value="2">es wird kein Zimmer benötigt</option>
											</select>
											<h5>MEINE NACHRICHT AN DIE MITARBEITER VON FUTURE</h5>
											<textarea name="anmeldung_geschaftlich[hotel-registration-data][message_to_staff]" rows="6"></textarea>
										</div>
									</div>
									<div class="row">
										<div class="col-xs-12">
									...
									<div class="row">
										<div class="col-sm-12">
											<p>Hinweis: Mit * gekennzeichnete Felder sind Pflichtfelder!</p>
											<button type="submit" name="anmeldung_geschaftlich[submit]"><?= _e('Anmeldung absenden', 'schnel')?></button>
										</div>
									</div>
								</form>
							</div>
		...
		<script>
			jQuery(document).ready( function(){
				...
				jQuery('#add-person').live( 'click', function(){
					var maqueta = jQuery('.teilnehmer-form');
					if (maqueta.length > 1){
