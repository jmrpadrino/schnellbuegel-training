            ...
            <div class="events-content">
                <div class="events-search">
                    <form id="events-filter" role="form">
                        ...
                        <?php } ?>
                        <button type="submit" class="button btn-search-events"><?= _e('Suchen','schnell') ?> <i class="fas fa-angle-double-right"></i></button>
                    </form>
                </div>
