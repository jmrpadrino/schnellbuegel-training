            ...
            */ ?>
            <a href="<?= home_url('kontakt')?>">
                <div class="in-house-link">
                    <img src="<?= SCHNELL_PLUGIN_URI ?>/frontend/images/home-map-location-1.png"><span>Dieses Angebot können Sie auch als Inhouse-Seminar buchen. Sprechen Sie uns an!</span>
                </div>
			</a>
			<?php
                /**
